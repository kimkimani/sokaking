...
export const BASE_URL_TO_PAGE_MAP: Record<string, string> = {
  ...
  '/free-sportpesa-mega-jackpot-prediction': 'sportpesa-mega',
...
export const BASE_PAGE_TO_URL_MAP: Record<string, string> = {
  ...
  'sportpesa-mega': '/free-sportpesa-mega-jackpot-prediction',
  'sportpesa-midweek': '/today-sportpesa-midweek-jackpot-prediction-and-tips',
