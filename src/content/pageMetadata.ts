...
export const PAGE_METADATA_MAP: Record<string, PageMetadata> = {
  ...
  "4soka-tips-prediction": {
    ...
    "inboundHeading": "Alternative Prediction Portals & Mathematical Tips",
    ...
    "inboundSubtitle": "Compare daily algorithmic models, banker accuracy rates, and Poisson distributions with top soccer analytics networks.",
