        ...
        return (
          <div className="space-y-8 animate-fade-in text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-5 rounded-[var(--radius)] bg-[var(--card)] border border-[var(--border)] space-y-3">
                <div className="w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-900 dark:text-slate-100 border border-slate-300 dark:border-slate-700">
                    ...
                    <div key={author.id} className="p-4 rounded-[var(--radius)] bg-[var(--card)] border border-[var(--border)] space-y-2.5">
                      <div className="flex items-center gap-3">
                        {author.avatar ? (
                          ...
                          <div className="w-10 h-10 rounded-full bg-emerald-700 text-white flex items-center justify-center font-black font-mono text-sm shrink-0">
                            {initials}
                          </div>
                        )}
                    ...
                    <div className="pt-2 border-t border-[var(--border)] space-y-1.5">
                      ...
                      <div className="flex flex-wrap gap-2 text-[11px] font-mono">
                        {siteContacts.telegram && (
                          <a href={siteContacts.telegram} target="_blank" rel="nofollow noopener noreferrer" className="px-2.5 py-1 rounded bg-sky-100 dark:bg-sky-950/40 text-slate-950 dark:text-slate-100 border border-sky-300 dark:border-sky-700 font-bold hover:bg-slate-900 hover:text-white transition-colors">
                            Telegram
                          </a>
                        )}
                        {siteContacts.facebook && (
                          <a href={siteContacts.facebook} target="_blank" rel="nofollow noopener noreferrer" className="px-2.5 py-1 rounded bg-blue-100 dark:bg-blue-950/40 text-slate-950 dark:text-slate-100 border border-blue-300 dark:border-blue-700 font-bold hover:bg-slate-900 hover:text-white transition-colors">
                            Facebook
                          </a>
                        )}
                        {siteContacts.twitter && (
                          <a href={siteContacts.twitter} target="_blank" rel="nofollow noopener noreferrer" className="px-2.5 py-1 rounded bg-slate-100 dark:bg-slate-800 text-slate-950 dark:text-slate-100 border border-slate-300 dark:border-slate-700 font-bold hover:bg-slate-900 hover:text-white transition-colors">
                            X (Twitter)
                          </a>
                        )}
                        {siteContacts.instagram && (
                          <a href={siteContacts.instagram} target="_blank" rel="nofollow noopener noreferrer" className="px-2.5 py-1 rounded bg-pink-100 dark:bg-pink-950/40 text-slate-950 dark:text-slate-100 border border-pink-300 dark:border-pink-700 font-bold hover:bg-slate-900 hover:text-white transition-colors">
                            Instagram
                          </a>
                        )}
                      </div>
                  ...
                  {formSubmitted ? (
                    <div className="py-12 text-center space-y-4 animate-scale-up">
                      ...
                      <button 
                        ...
                        className="px-4 py-2 bg-slate-100 hover:bg-slate-900 hover:text-white dark:bg-slate-800 dark:hover:bg-slate-950 text-slate-900 dark:text-slate-100 text-xs font-black font-mono uppercase rounded-lg border border-slate-300 dark:border-slate-700 cursor-pointer mt-4 transition-colors"
                      >
                    ...
                    <form onSubmit={handleContactSubmit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={submitting}
                        className="w-full py-3 bg-emerald-700 hover:bg-slate-900 text-white text-xs font-black rounded-lg border-none cursor-pointer flex items-center justify-center gap-2 shadow-sm disabled:opacity-50 transition-all duration-200"
                      >
                        {submitting ? (
