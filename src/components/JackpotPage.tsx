  ...
  return (
    <div className="space-y-6 text-left">
      ...
      <div className="p-5 md:p-6 rounded-[var(--radius)] bg-[var(--card)] border border-[var(--border)] shadow-[var(--shadow)] relative overflow-hidden text-left space-y-3">
        ...
        <div className="flex items-center gap-2">
          <span className="px-2.5 py-1 rounded text-[9px] font-black uppercase tracking-wider font-mono bg-amber-100 dark:bg-amber-950 text-amber-950 dark:text-amber-100 border border-amber-300 dark:border-amber-700 flex items-center gap-1 shadow-2xs">
            <Trophy className="w-3 h-3 text-amber-900 dark:text-amber-300" /> High Confidence
          </span>
                  ...
                  <div className="col-span-12 md:col-span-5 flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0 flex-1 text-left space-y-1.5">
                      ...
                      <div className="flex items-center flex-wrap gap-1.5 text-[9px] sm:text-[9.5px] font-black text-slate-800 dark:text-slate-200 font-mono uppercase tracking-wider min-w-0 leading-none">
                        ...
                        {isDoubleChance && (
                          <span className="px-1.5 py-0.5 bg-amber-100 dark:bg-amber-950 text-amber-950 dark:text-amber-100 border border-amber-300 dark:border-amber-700 rounded text-[8.5px] tracking-normal lowercase shrink-0 font-sans leading-none font-black shadow-2xs">double chance</span>
                        )}
                      </div>
