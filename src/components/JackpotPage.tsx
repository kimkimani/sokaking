  ...
  return (
    <div className="space-y-6 text-left">
      ...
      <div className="p-5 md:p-6 rounded-[var(--radius)] bg-[var(--card)] border border-[var(--border)] shadow-[var(--shadow)] relative overflow-hidden text-left space-y-3">
        ...
        <div className="flex items-center gap-2">
          <span className="px-2.5 py-1 rounded text-[9px] font-black uppercase tracking-wider font-mono bg-amber-100 dark:bg-amber-950/40 text-slate-950 dark:text-slate-100 border border-amber-300 dark:border-amber-700 flex items-center gap-1 shadow-2xs">
            <Trophy className="w-3 h-3 text-amber-600 dark:text-amber-400" /> High Confidence
          </span>
          <span className="text-[10.5px] text-slate-800 dark:text-slate-200 font-mono font-black uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 items-stretch text-left">
        ...
        <div className="p-5 rounded-[var(--radius)] bg-[var(--card)] border border-amber-500/30 shadow-[var(--shadow)] flex flex-col justify-between gap-4 lg:col-span-7">
              ...
              >
                ...
                <div className="p-2.5 sm:p-3 grid grid-cols-12 items-center gap-3">
                  ...
                  <div className="col-span-12 md:col-span-5 flex items-center gap-2.5 min-w-0">
                    ...
                    <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-lg ${isUnlocked ? 'bg-[var(--primary)] text-white font-black' : 'bg-amber-100 dark:bg-amber-950/40 text-slate-950 dark:text-slate-100 border border-amber-300 dark:border-amber-700 font-bold'} text-[10.5px] sm:text-[11px] font-mono flex items-center justify-center shrink-0 shadow-2xs`}>
                      {match.fixtureNumber}
                    </div>
                    ...
                    <div className="min-w-0 flex-1 text-left space-y-1.5">
                      ...
                      <div className="flex items-center flex-wrap gap-1.5 text-[9px] sm:text-[9.5px] font-black text-slate-800 dark:text-slate-200 font-mono uppercase tracking-wider min-w-0 leading-none">
                        ...
                        {match.status === 'HT' && (
                          <span className="px-2 py-0.5 bg-amber-400 text-slate-950 font-black rounded text-[8.5px] tracking-normal font-mono leading-none">
                            HT
                          </span>
                        )}
                        {match.status === 'FT' && (
                        ...
                        {isDoubleChance && (
                          <span className="px-1.5 py-0.5 bg-amber-100 dark:bg-amber-950/40 text-slate-950 dark:text-slate-100 border border-amber-300 dark:border-amber-700 rounded text-[8.5px] tracking-normal lowercase shrink-0 font-sans leading-none font-black shadow-2xs">double chance</span>
                        )}
                      </div>
                      ...
                      return (
                        <button
                          ...
                          className={`relative py-2 px-1 rounded-xl border font-mono text-center transition-all duration-200 flex flex-col items-center justify-center min-h-[48px] overflow-hidden ${
                            !isUnlocked
                              ? 'bg-slate-50 dark:bg-slate-950/40 border-dashed border-slate-300 dark:border-slate-800 text-slate-700 dark:text-slate-300 cursor-pointer'
                              : isPick
                        ...
                        >
                          <span className={`text-[8.5px] font-black block uppercase scale-90 leading-none mb-0.5 tracking-wider ${isPick && isUnlocked ? 'text-slate-950 font-black' : 'text-slate-700 dark:text-slate-300'}`}>
                            {label}
                          </span>
                      ...
                      {isUnlocked ? (
                        <span className={`px-2.5 py-1 rounded-full text-xs font-black font-mono leading-none border shadow-3xs ${
                          displayConf >= 80 
                            ...
                            : displayConf >= 70 
                              ? 'bg-blue-100 dark:bg-blue-950/40 text-slate-950 dark:text-slate-100 border-blue-300 dark:border-blue-700' 
                              : 'bg-amber-100 dark:bg-amber-950/40 text-slate-950 dark:text-slate-100 border-amber-300 dark:border-amber-700'
                        }`}>
                          {displayConf}%
                        </span>
                      ) : (
                        <span className="px-2 py-1 rounded-full text-[10.5px] font-black font-mono leading-none border shadow-3xs bg-amber-100 dark:bg-amber-950/40 text-slate-950 dark:text-slate-100 border-amber-300 dark:border-amber-700 flex items-center gap-1">
                      ...
                      {isUnlocked ? (
                        <>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="px-2 py-0.5 rounded bg-emerald-100 dark:bg-emerald-950/40 text-slate-950 dark:text-slate-100 border border-emerald-300 dark:border-emerald-700 text-[10px] font-black font-mono">
                              {match.prediction}
                            </span>
                          </div>
      ...
      {!hasPaid && (
        ...
        >
          <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center mx-auto text-slate-900 dark:text-slate-100 border border-slate-300 dark:border-slate-700 group-hover:scale-110 transition-transform">
